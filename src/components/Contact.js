            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href={profile.social.linkedin} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
                  linkedin.com/in/yashan-setia-03a463249
                </a>
              </div>
              <div className="flex items-center gap-3">
            ...
            <form className="rounded-xl border border-border bg-card p-5 shadow-sm" onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full rounded-md border border-border bg-background px-3 py-2 text-sm outline-none focus-visible:ring-2 focus-visible:ring-ring"
                  value={formData.email} onChange={handleChange} required placeholder="Your email"
                />
              </div>
              <div className="mb-4">
                ...
                <textarea
                  ...
                  value={formData.message} onChange={handleChange} required placeholder="Your message" rows="5"
                />
              </div>
              <button
                type="submit"
                className="inline-flex w-full items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:opacity-90 transition-opacity disabled:opacity-50"
